...
- (void)viewDidLoad {
    ...
    self.title = @"预览";
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithTitle:@"使用视频" style:UIBarButtonItemStylePlain target:self action:@selector(useVideo)];;
    ...
    playImg.center = CGPointMake([UIScreen mainScreen].bounds.size.width/2, [UIScreen mainScreen].bounds.size.height/2);
